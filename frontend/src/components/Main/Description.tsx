          ...
          <div className={styles.SecondBorder}>
            ...
            <div>
              ...
              <div className={styles.DescriptionDiv} data-aos="fade-right">
                <p className={styles.Description}>With this project, I want to show that I can learn and work
            ...
            <div>
              ...
              <div className={styles.DescriptionDivDesign} data-aos="fade-left">
                <p className={styles.DescriptionDesign}>I used the design of
                  the site in calm and ordinary colors.
                  I'm not a great designer, but I have a passion for it.
                  I like to create something beautiful and new
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className={styles.DescriptionDiv} data-aos="fade-right">
                <p className={styles.Description}>I can make a few mistakes in
                  clean code, it may not look very clean,
                  but I am constantly learning and practicing.
                  I accept my mistakes and try to fix them
                </p>
              </div>
            </div>
                  ...
                  <div className={styles.Card}>
                    <Card sx={{ width: 220 }} style={{
                      ...
                      <CardContent>
                        ...
                        <Typography gutterBottom variant="h5" component="div" color="white" className={styles.CardText}>
                          Responisve
                        </Typography>
                        <Typography variant="body2" color="#cccccc" className={styles.CardText}>
                          I'm trying to make a responsive front-end so that
                          users from anywhere in the world, on any gadget,
                    ...
                    <Card sx={{ width: 220 }} style={{
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="#cccccc" className={styles.CardText}>
                          ...
                          users don't have to reload or wait for content
